...
API_ID = int(environ['25761845'])
API_HASH = environ['bc84b3109a615cdc08d02f4c1576dcaa']
BOT_TOKEN = environ[5914776383:AAHKpyDmo5tJ_jvSQlIa_t3KODpbOjXcUCA']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('5258668078', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1001676739936', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
ADMINS.append(1684438752)
auth_channel = environ.get('-1001768029385')
...
# Others
LOG_CHANNEL = int(environ.get('L-1001798408136', 0))
